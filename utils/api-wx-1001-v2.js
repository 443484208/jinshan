var API_APP_ID= 1001;
var API_CREATE_TIME= 1586954155598;
...
getApiRequestJson("/api/account/register/add",param,function(res) {
jinguang.__callback(res, param);});},
...
jinguang.__callback(res, param);});},
getCompanyCategoryList: function(param){
getApiRequestJson("/api/company/category/list",param,function(res) {
jinguang.__callback(res, param);});},
...
getApiRequestJson("/api/message/delete",param,function(res) {
jinguang.__callback(res, param);});},
readAllMessage: function(param){
getApiRequestJson("/api/message/all/read",param,function(res) {
jinguang.__callback(res, param);});},
readMessage: function(param){
getApiRequestJson("/api/message/read",param,function(res) {
jinguang.__callback(res, param);});},
getMessageList: function(param){
getApiRequestJson("/api/message/list",param,function(res) {
jinguang.__callback(res, param);});},
sendMessage: function(param){
getApiRequestJson("/api/message/send",param,function(res) {
jinguang.__callback(res, param);});},
getMessageSessionList: function(param){
getApiRequestJson("/api/message/session/list",param,function(res) {
jinguang.__callback(res, param);});},
readMessageListByMessageIds: function(param){
getApiRequestJson("/api/message/list/read",param,function(res) {
jinguang.__callback(res, param);});},
getUnreadMessageCount: function(param){
getApiRequestJson("/api/message/count/unread",param,function(res) {
jinguang.__callback(res, param);});},
...
jinguang.__callback(res, param);});},
getUserNeedList: function(param){
getApiRequestJson("/api/need/list/user",param,function(res) {
jinguang.__callback(res, param);});},
getQrCodeBase64Data: function(param){
getApiRequestJson("/api/common/qrcode",param,function(res) {
jinguang.__callback(res, param);});},
getIntegralDetail: function(param){
getApiRequestJson("/api/common/integral/detail",param,function(res) {
jinguang.__callback(res, param);});},
...
jinguang.__callback(res, param);});},
saveIntegral: function(param){
getApiRequestJson("/api/common/integral",param,function(res) {
jinguang.__callback(res, param);});},
getCountInfo: function(param){
getApiRequestJson("/api/count/info",param,function(res) {
jinguang.__callback(res, param);});},
getNewNoteList: function(param){
getApiRequestJson("/api/newNote/list",param,function(res) {
jinguang.__callback(res, param);});},
getNewNoteDetail: function(param){
getApiRequestJson("/api/newNote/detail",param,function(res) {
jinguang.__callback(res, param);});},
saveNewNote: function(param){
getApiRequestJson("/api/newNote/save",param,function(res) {
jinguang.__callback(res, param);});},
updateNewNoteStatus: function(param){
getApiRequestJson("/api/newNote/update/status",param,function(res) {
jinguang.__callback(res, param);});},
...
getApiRequestJson("/api/account/update/password",param,function(res) {
jinguang.__callback(res, param);});},
...
jinguang.__callback(res, param);});},
updateAccountStatus: function(param){
getApiRequestJson("/api/account/update/status",param,function(res) {
jinguang.__callback(res, param);});},
...
getApiRequestJson("/api/activity/list",param,function(res) {
jinguang.__callback(res, param);});},
deleteActivity: function(param){
getApiRequestJson("/api/activity/delete",param,function(res) {
jinguang.__callback(res, param);});},
saveActivity: function(param){
getApiRequestJson("/api/activity/save",param,function(res) {
jinguang.__callback(res, param);});},
getActivityDetail: function(param){
getApiRequestJson("/api/activity/detail",param,function(res) {
jinguang.__callback(res, param);});},
getActivityRelevanceList: function(param){
getApiRequestJson("/api/activity/relevance/list",param,function(res) {
jinguang.__callback(res, param);});},
